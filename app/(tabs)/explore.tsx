...
import { useLocationStore, useStationStore, useVehicleStore } from '../../store';
...
export default function ExploreScreen() {
  ...
  const { nearbyStations, searchFilters, updateSearchFilters } = useStationStore();
  ...
  const stations = nearbyStations.length > 0 ? nearbyStations : mockStations;
